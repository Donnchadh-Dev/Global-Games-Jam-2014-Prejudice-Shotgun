...
package org.flixel.plugin.photonstorm 
{
	...
	public class FlxWeapon 
	{
		 ...
		 * 
		 * @param	rate	The delay in seconds (s) between which each bullet is fired, set to zero to clear
		 */
		 ...
		 * 
		 * @param	lifespan	The lifespan of the bullet in seconds, calculated when the bullet is fired. Set to zero to disable bullet lifespan.
		 */
